...
class MovieConfig:
    ...
    Attributes:
        movie_base_url (str): L'URL de base pour les appels d'API.
        movie_backoff (bool): Indique si le backoff progressif est activé.
        movie_backoff_max_time (int): Le temps maximal de backoff en secondes.
    """
